    ...
    >
      ...
      <motion.div
        className="absolute top-0 left-0 right-0 bottom-0 m-auto 
                   w-10 h-10 rounded-full bg-[#cfa4f5]"
        animate={{
          scale: [6,7,6],
        }}
        transition={{
      ...
      {/* PULSE CIRCLE 2 — delayed */}
      <motion.div
        className="absolute top-0 left-0 right-0 bottom-0 m-auto 
                   w-10 h-10 rounded-full bg-[#dabaf7]"
        animate={{
          scale: [4,5,4],
        }}
        transition={{
...
function Gear({ className = "" }) {
  return (
    <svg
      className={`animate-[spin_7s_linear_infinite] fill-black size-7  ${className}`}
      height="200px"
      width="200px"
      viewBox="0 0 512 512"
      fill="#ffffff"
