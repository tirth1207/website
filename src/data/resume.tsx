...
export const DATA = {
  name: "Tirth Rathod ",
  initials: "TR",
  url: "https://rathodandcloths.shop",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/tirth1207",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/tirth-rathod-2b2074328",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/RathodTirth123",
        icon: Icons.x,
  ...
  education: [
    ...
    {
      school: "The H.B.K. New High School",
